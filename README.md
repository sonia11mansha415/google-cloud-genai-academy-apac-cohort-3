...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=12,2,24,20,0&height=235&section=header&text=Google%20Cloud%20Gen%20AI%20Academy&fontSize=44&fontColor=ffffff&animation=fadeIn&fontAlignY=34&desc=APAC%20Cohort%203%20%E2%80%A2%20Sonia%20Mansha%20%E2%80%A2%20Accelerate%20AI%20with%20Cloud%20Run&descSize=17&descAlignY=55&descColor=E8F0FE" width="100%" alt="Google Cloud Gen AI Academy APAC Cohort 3 portfolio header" />
...
[![Academy Overview](https://img.shields.io/badge/%F0%9F%A7%AD%20Academy-Overview-4285F4?style=for-the-badge)](./00-academy-overview/)
[![Track 1](https://img.shields.io/badge/%E2%98%95%20Track%201-RAG%20Agent-00B8D9?style=for-the-badge)](./01-track-1-rag-adk-cloud-run/)
[![Track 2](https://img.shields.io/badge/%F0%9F%93%8A%20Track%202-BigQuery%20MCP-7C4DFF?style=for-the-badge)](./02-track-2-gemini-bigquery-mcp/)
[![Track 3](https://img.shields.io/badge/%E2%9A%99%EF%B8%8F%20Track%203-Productivity%20Agent-34A853?style=for-the-badge)](./03-track-3-productivity-agent/)

<br/>

**Three tracks. Three cloud builds. One security-first GenAI journey.**

<sub>Personal learning portfolio by <strong>Sonia Mansha</strong> · Not an official Google Cloud repository</sub>
...
<p>Build a customer-facing AI Barista using Google ADK and Gemini, ground its recommendations in a controlled menu source, wrap it in Streamlit, and deploy it to Cloud Run.</p>
...
<p>Connect a Gemini-powered ADK agent to BigQuery through the managed MCP server so the agent can inspect structured data, formulate SQL, and reason from verified query results.</p>
<p><code>ADK</code> <code>Gemini</code> <code>BigQuery</code> <code>MCP</code> <code>Cloud Run</code></p>
<p><a href="./02-track-2-gemini-bigquery-mcp/"><strong>Open Track 2 →</strong></a></p>
</td>
<td width="33%" valign="top">
<h3>⚙️ Track 3 — Productivity Agent</h3>
<p><strong>Status:</strong> ⏳ Queued</p>
<p>Build a personal operations assistant that analyzes business data, executes code in a sandboxed environment, and requests explicit human approval before changing operational data.</p>
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,20,24,2,12&height=110&section=footer" width="100%" alt="Portfolio footer" />
