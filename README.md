...
<p>Connect a Gemini-powered ADK agent to BigQuery through the managed MCP server so it can inspect structured data, execute read-oriented analysis, and reason from query results.</p>
